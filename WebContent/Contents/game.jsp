...
function replay() {
	...
	if(score>5){
		alert("축하합니다! 1000포인트가 지급되었습니다!")
		window.location.href = "<%=request.getContextPath()%>/game.do"; 
	}else{
		alert("점수가 부족해요.. 내일 다시 도전해주세요!")
...
<div class="ctn">
    ...
    <input type="hidden" id="score" name="score" value="@@@@@@">
      ...
      <div id="replay">마일리지 얻기</div>
    </div>
  </div>
  <div class="rollet-footer">
        <button type="button" class="btn btn-info" id="finish" style="color: #fff;">닫기</button>
    </div>
  </div>
</body>
</html>