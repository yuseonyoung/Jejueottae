...
<body>
	...
	<div class="" style="text-align: center;">
		<a href="<%=request.getContextPath()%>/Contents/index.jsp"><img class="img-fluid" src="<%=request.getContextPath()%>/Contents/img/logo.png"
			alt="Logo"></a>
		<div class="form-outer container">
			<div class="page slidepage">
				<div class="title">
					<img src="<%=request.getContextPath()%>/Contents/img/idImg.jpg" alt="아이디찾기" class="idSrcImg"> 아이디 찾기
				</div>
				<br> <br>
				<p id="sort1" style="text-align: center;"><br>
					<%
					/*  String id ="MiddleQeuka"; */ 
				...
				<div id="sortA" class="mb-3">
					...
					<a href="<%=request.getContextPath()%>/Contents/signUp.jsp">회원가입</a> <span>I</span> <a href="<%=request.getContextPath()%>/Contents/pwSearch.jsp">비밀번호
						찾기</a>
				</div>
			</div>
		</div>
