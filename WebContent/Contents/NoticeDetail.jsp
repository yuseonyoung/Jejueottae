...
.cel_content2{
	text-align: left;
            white-space: pre-line; /* 들여쓰기와 줄바꿈 유지를 위해 추가 */
            font-family: 'Arial', sans-serif; /* 선택적으로 폰트 지정 */
}
...
<body>
  ...
  <div class="page-title">
        ...
        <% View_BoardVO board = (View_BoardVO)request.getAttribute("viewVO"); %>
            ...
            <table class="board-table">
				...
				<tr style="width: 100%;">
					...
					<td class="r_none" style="width: 25%;">
						공지
					</td>
					<th scope="row" class="none" style="width: 25%;">
						작성자
					</th>
					<td style="width: 25%;">
						관리자
            ...
            <div class="bx_qna">
				<div class="title"><strong>내용</strong></div>
			...
			<div class="NoticelistBtn">
				<button onclick="goToNoticeList()">목록</button>
					<% 
						if(id.equals("Admin1")){
					%> 
	...
	<form action="/board/remove.do" method="post" id="frm">
