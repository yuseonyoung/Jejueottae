...
<body>
 ...
 <div class="board_wrap">
        <div class="board_title">
            <strong>  공동 구매 글 작성하기  </strong>
            <p> 합리적이고 편한 즐거운 여행을 두배로 !  </p>
        </div>
            ...
            <div class="board_write">
                ...
                <div id="domitory">
               	 	<select name='domi'>
 						 ...
 						 <option value='domi_4'> 도미토리 4인 </option>
						 <option value='domi_6'> 도미토리 6인 </option>
 						 <option value='domi_8'> 도미토리 8인 </option>
					</select>
                </div>
...
글 내용이 들어갑니다.</textarea>
 ...
 <!-- 여기까지 입력할거야  -->
  <div id="drop-area">
    ...
    <label class="button" for="fileElem"> <strong id="dd1">사진 등록 </strong></label>
  
  <progress id="progress-bar" max=100 value=0></progress>
  <div id="gallery" /> <!-- 얘가 사진을 받아와야해    -->
</div>
</div>
		<!-- Footer Start -->
