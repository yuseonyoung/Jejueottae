...
<body>
  ...
  <div class="" style="text-align: center;">
    ...
    <div class="form-outer container">
      <form action="<%=request.getContextPath()%>/findInfo/pass.do">
        <div class="page slidepage">
          ...
          <br>
          <p id="sort1">
          	  가입하실때 입력하신 정보를 입력하시면<br>
          	  이메일로 <strong>비밀번호</strong>를 보내드립니다.
          ...
          <div class="fieldWrap">
             ...
             <div class="field">
         	  <input type="text" name="uemail" placeholder="이메일을 입력해주세요">
             </div> 
          </div>
